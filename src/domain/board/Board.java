...
public class Board {
    ...
    private void initializeSquares() {
        ...
        * */
        /*rents  layer 1*/
        int[] MediterranianAve = {2, 10, 30, 90, 160, 250, 750 };
        int[] BalticAve = {4, 20, 60, 180, 320, 450, 900};
        int[] OrientalAve = {6, 30, 90, 270, 400, 550, 1050};
        int[] VermontAve = {6, 30, 90, 270, 400, 550, 1050};
        int[] ConnecticutAve = {8, 40, 100, 300, 450, 600, 1100};
        int[] StCharlesPlace = {10, 50, 150, 450, 625, 750, 1250};
        int[] StatesAve = {10, 50, 150, 450, 625, 750, 1250};
        int[] VirginiaAve = {12, 60, 180, 500, 700, 900, 1400};
        int[] StJamesPlace = {14, 70, 200, 550, 750, 950, 1450};
        int[] TennesseeAve ={14, 70, 200, 550, 750, 950, 1450};
        int[] NewYorkAve = {16, 80, 220, 600, 800, 1000, 1500};
        int[] KentuckyAve = {18, 90, 250, 700, 875, 1050, 2050};
        int[] IndianaAve = {18, 90, 250, 700, 875, 1050, 2050};
        int[] IllinoisAve = {20, 100, 300, 750, 925, 1100, 2100};
        int[] AtlanticAve = {22, 110, 330, 800, 975, 1150, 2150};
        int[] VentnorAve = {22, 110, 330, 800, 975, 1150, 2150};
        int[] MarvinGardens = {24, 120, 350, 850, 1025, 1200, 2200};
        int[] PacificAve = {26, 130, 390, 900, 1100, 1275, 2275};
        int[] NorthCarolinaAve = {26, 130, 390, 900, 1100, 1275, 2275};
        int[] PennsylvaniaAve = {150, 450, 1000, 2000, 1400, 2400};
        int[] ParkPlace = {35, 175, 500, 1100, 1300, 1500, 2500};
        int[] Boardwalk = {50, 200, 600, 1400, 1700, 2000, 3000};

        int[] LombardSt = {17,85,240,475,670,1025,1525};
        int[] Embarcadero = {17,85,240,475,670,1025,1525};
        int[] FishermansWharf = {21,105,320,780,950,1125,1625};

        /*rents  layer 0,2*/
        int[] BiscayneAve = {11,55,160,475,650,800,1300 };
        int[] MiamiAve = {9,45,120,350,500,700,1200};
        int[] FloridaAve = {9,45,120,350,500,700,1200};
        int[] BeaconSt = {30,160,470,1050,1250,1500,2500};
        int[] BoylstonSt = {30,160,470,1050,1250,1500,2500};
        int[] NewburySt = {40,185,550,1200,1500,1700,2700};
        int[] FifthAve = {60,220,650,1500,1800,2100,3600};
        int[] MadisonAve = {60,220,650,1500,1800,2100,3600};
        int[] WallSt = {80,300,800,1800,2200,2700,4200};
        int[] LakeSt ={1,5,15,45,80,125,625};
        int[] NicolletAve = {1,5,15,45,80,125,625};
        int[] HennepinAve = {1,5,15,45,120,240,350,850};
        int[] Esplanade = {5,25,80,225,360,600,1000};
        int[] KatyFreeway = {11,55,160,475,650,800,1300};
        int[] WestheimerRd = {11,55,160,475,650,800,1300};
        int[] KirbyDr = {14,70,200,550,750,950,1450};
        int[] CullenBlvd = {14,70,200,550,750,950,1450};
        int[] CanalSt = {5,25,80,225,360,600,1000};
        int[] MagazineSt = {8,40,100,300,450,600,1100};
        int[] BourbonSt = {8,40,100,300,450,600,1100};
        int[] DekalbAve = {17,85,240,670,840,1025,1525};
        int[] YoungIntlBlvd = {17,85,240,670,840,1025,1525};
        int[] DecaturSt= {20,100,300,750,925,1100,1600};
        int[] PeachtreeSt= {20,100,300,750,925,1100,1600};
        int[] RandolphSt= {23,115,345,825,1010,1180,2180};
        int[] LakeShoreDr= {23,115,345,825,1010,1180,2180};
        int[] WackerDr= {26,130,390,900,1100,1275,2275};
        int[] MichiganAve= {26,130,390,900,1100,1275,2275};
        int[] SouthTemple= {32,160,470,1050,1250,1500,2500};
        int[] WestTemple= {32,160,470,1050,1250,1500,2500};
        /*Hotel decreaes rent !!*/
        int[] NorthTemple= {38,170,520,1125,1425,1275,1650};
        int[] TempleSquare= {38,170,520,1125,1425,1275,1650};
        int[] SouthSt= {45,210,575,1300,1600,1800,3300};
        int[] BroadSt= {45,210,575,1300,1600,1800,3300};
        int[] WalnutSt= {55,225,630,1450,1750,2050,3550};
        int[] MarketSt= {55,225,630,1450,1750,2050,3550};
        int[] MulhollandBlvd= {70,350,750,1600,1850,2100,3600};
        int[] VenturaBlvd= {80,400,825,1800,2175,2550,4050};
        int[] RodeoDr= {90,450,900,2000,2500,3000,4500};

        /*cab rents different ???*/
        int[] utilityRent= {4,10,20,40,80,100,120,150};
        int[] utilityRentCab= {30,60,120,240};
        int[] railRoadRent= {3,60,120,240};
        ...
        Property sq94 = new Property("Park Place", 350, 37, 1, ParkPlace, "BLUE");
