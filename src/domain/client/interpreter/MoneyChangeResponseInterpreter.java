...
public class MoneyChangeResponseInterpreter implements ResponseInterpretable {
    ...
    public void interpret(String[] message) {
        ...
        if (message[2].substring(0, message[2].indexOf("@")).equals("Go"))
            UIUpdater.getInstance().setMessage(name + " passed Go Square and his/her money increased by " + changedMoney);
        else if (message[2].substring(0, message[2].indexOf("@")).equals("BonusP"))
            UIUpdater.getInstance().setMessage(name + " passed Bonus Square and his/her money increased by " + changedMoney);
        else if (message[2].substring(0, message[2].indexOf("@")).equals("BonusL"))
            UIUpdater.getInstance().setMessage(name + " landed Bonus Square and his/her money increased by " + changedMoney);
