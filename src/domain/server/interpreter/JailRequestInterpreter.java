...
//            UIUpdater.getInstance().setMessage(GameLogic.getInstance().getCurrentPlayerName().getName() + " goes to jail!!!");
//        }else if (message[0].charAt(0) == GameLogic.goOutJailFlag){
//            GameLogic.getInstance().getCurrentPlayerName().setInJail(false);
//            UIUpdater.getInstance().setMessage(GameLogic.getInstance().getCurrentPlayerName().getName() + " is out of jail!!!");
//        }
    }
}
